...
abstract class Combination {
    ...
    private static function flattenArray($entries){
        ...
        $flattenArray[0] = ['value' => '', 'level' => 0, 'next' => 1, 'offset' => 0, 'next_sibling' => null];
        $flattenOffset = 1;
        for($i=0;$i<$nbEntries;$i++){
            ...
            for($j=0;$j<$nbElements;$j++){
                ...
                $flattenArray[$flattenOffset++] = ['offset' => $flattenOffset, 'value' => $entries[$i][$j], 'next' => $nextOffset, 'next_sibling' => $nextSibling];
            }
        }
        return $flattenArray;
    }
